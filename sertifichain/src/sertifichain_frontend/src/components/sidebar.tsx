...
const Sidebar = () => {
    ...
    return (
        <nav className="flex flex-col bg-gradient-to-b from-[#050C1B] to-[#183981] mx-8 my-16 rounded-xl shadow-md shadow-gray-300">
            <div className="h-full w-full bg-[url('/background/sidebar.png')] bg-cover bg-center pt-6 px-8 rounded-t-xl flex flex-col justify-between">
                <div className="flex items-start space-x-2">
                    ...
                    <span className="text-2xl font-bold leading-tight text-white mt-0.5">SertifiChain</span>
                </div>
