    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0F172A] to-[#0A0F1E] text-white font-poppins">
      ...
      <section className="py-16">
        ...
        <div className="flex flex-col items-center gap-8 mt-10">
          ...
          {/* Card 1 */}
          {/* 
           * Card 1: Cek Sertifikat
           * 
           * This card showcases the ability to check a certificate.
           */}
          <div className="w-[80%] md:w-[60%] p-8 rounded-[30px] shadow-lg bg-gradient-to-r from-[#2C6267] via-[#254E60] to-[#193551] text-white">
            ...
            <button className="relative mt-4 px-17 py-3 rounded-lg bg-gradient-to-r from-[#152F55] to-[#1B3D83] 
          ...
          {/* Card 2 */}
          {/* 
           * Card 2: Cek Daftar Kepemilikan
           * 
           * This card showcases the ability to check the ownership of a certificate.
           */}
          <div className="w-[80%] md:w-[60%] p-8 rounded-[30px] shadow-lg bg-gradient-to-r from-[#2C6267] via-[#254E60] to-[#193551] text-white">
          ...
          {/* Card 3 */}
          {/* 
           * Card 3: Pindah Tangan Sertifikat
           * 
           * This card showcases the ability to transfer the ownership of a certificate.
           */}
          <div className="w-[80%] md:w-[60%] p-8 rounded-[30px] shadow-lg bg-gradient-to-r from-[#2C6267] via-[#254E60] to-[#193551] text-white">
